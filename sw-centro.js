...
const precacheFiles = [
  ...
  /* TEMPLATES */
  '/templates/archivos.html?v=2',
  '/templates/configuracion.html?v=2',
  '/templates/eventos.html?v=2',
  '/templates/informacion.html?v=2',
  '/templates/menu.html?v=2',
  '/templates/mopep.html?v=2',
  '/templates/profesores.html?v=2',
  '/templates/progresa.html?v=2',
  '/templates/salones.html?v=2',
  '/templates/voluntariado.html?v=2',
  /* STYLES */
  '/css/conf.css?v=6',
  '/css/login.css?v=6',
